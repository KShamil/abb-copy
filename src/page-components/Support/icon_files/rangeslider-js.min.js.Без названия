!function (t, e) {
    ...
    return function (t) {
        ...
        t.exports = function (t, e) {
            var n = (e = e || e.currentTarget).getBoundingClientRect(), s = t.originalEvent || t, r = 0, o = 0;
        ...
        var u = function () {
            ...
            emit: function (t, e, n) {
                ...
                for (var t = 0, e = arguments.length; t < e; t++) if (n = arguments[t], a(parseFloat(n)) || a(n)) return arguments[t];
                var n
        ...
        var p = function (t) {
            ...
            return e = t, (n = [{
                ...
                key: "_startEventListener", value: function (t) {
                    var e = t.target, n = this.identifier, i = !1;
                ...
                key: "_listen", value: function (t) {
                    var e = this, n = "".concat(t ? "add" : "remove", "EventListener");
                ...
                key: "_handleDown", value: function (t) {
                    if (t.preventDefault(), this.isInteracting = !0, this._listen(!0), !t.target.classList.contains(d.HANDLE_CLASS)) {
                        var e = c()(t, this.range).x, n = this.range.getBoundingClientRect().left,
                ...
                key: "_handleMove", value: function (t) {
                    this.isInteracting = !0, t.preventDefault();
        ...
        e.default = {
            RangeSlider: v, utils: l, create: function (t, e) {
                function n(t) {
